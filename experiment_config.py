...
EVAL_STANDARD = True    # produce val_detections.json for confusion analysis
...
# ---- autopsy (round 4) ------------------------------------------------------
RUN_AUTOPSY = False        # stage-by-stage information tracing
AUTOPSY_MAX_IMAGES = 548  # full val split
AUTOPSY_VIZ_IMAGES = 6    # densest images get qualitative PNG artifacts

RUN_CONFUSION = True      # round 6: class-confusion matrix + merge upper bound
